...
namespace ProgramManagerStudent
{
    ...
    class Student
    {
        ...
        {
            String content = "UUID, Full Name, Birthday, Gender, Class ID";
            foreach (Student student in studentList)
            {
                ...
                content += "\n" + student.ID + ", " + student.FullName + ", " + student.Birthday.ToString("dd/MM/yyyy") + ", " + gender + ", " + student.ClassID;
            }
            File.WriteAllText(@"..\..\..\Student.csv", content);
        }
